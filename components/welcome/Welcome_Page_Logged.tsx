/*
 * =========================================================================
 * FILE         :   components/welcome/Welcome_Page_Logged.tsx
 *
 * PROJECT      :   EventLoop
 *
 * DESCRIPTION  :   Welcome page content for users that are logged in.
 * =========================================================================
 */
...
/**
 * @brief  Renders the welcome page content for logged in users.
 * @return The JSX structure of the logged in welcome page.
 */
export default function Welcome_Page_Logged() {
    /* Returns the visible logged in welcome page content. */
    return (
