...
import { Calendar, Clock, MapPin, Users, Ticket, Euro, MessageSquare } from "lucide-react";
...
export default async function EventDetailPage({
  ...
  // Whether the logged-in attendee has a CONFIRMED booking for this event,
  // which unlocks messaging the organizer (requirement 10).
